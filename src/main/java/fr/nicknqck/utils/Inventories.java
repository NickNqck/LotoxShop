...
public class Inventories {
    ...
    public void openIronBuyInventory(Player player) {
        Inventory inv = Bukkit.createInventory(player, 9*3, "§c§n§lFer§7 -§6 "+ LotoxShop.getInstance().getStringCoins(player.getUniqueId())+" coins");
        for (int i = 0; i <= 9; i+=7){
            inv.setItem(i, new ItemBuilder(Material.WHITE_STAINED_GLASS_PANE).setName(" ").toItemStack());
            inv.setItem(i+1, new ItemBuilder(Material.WHITE_STAINED_GLASS_PANE).setName(" ").toItemStack());
        }
    ...
    public void openGoldBuyInventory(Player player) {
        Inventory inv = Bukkit.createInventory(player, 9*3, "§c§n§lOr§7 -§6 "+LotoxShop.getInstance().getStringCoins(player.getUniqueId())+" coins");
        for (int i = 0; i <= 9; i+=7){
            inv.setItem(i, new ItemBuilder(Material.WHITE_STAINED_GLASS_PANE).setName(" ").toItemStack());
            inv.setItem(i+1, new ItemBuilder(Material.WHITE_STAINED_GLASS_PANE).setName(" ").toItemStack());
        }
        ...
        inv.setItem(11, new ItemBuilder(Material.GOLD_INGOT).setName("§a+1").setAmount(1).toItemStack());
        inv.setItem(13, new ItemBuilder(Material.GOLD_INGOT).setName("§a+16").setAmount(16).toItemStack());
        inv.setItem(15, new ItemBuilder(Material.GOLD_INGOT).setName("§a+32").setAmount(32).toItemStack());
        inv.setItem(22, getReturnArrow());
        player.openInventory(inv);
    }
    public void openDiamondBuyInventory(Player player) {
        Inventory inv = Bukkit.createInventory(player, 9*3, "§c§n§lDiamant§7 -§6 "+LotoxShop.getInstance().getStringCoins(player.getUniqueId())+" coins");
        for (int i = 0; i <= 9; i+=7){
            inv.setItem(i, new ItemBuilder(Material.WHITE_STAINED_GLASS_PANE).setName(" ").toItemStack());
            inv.setItem(i+1, new ItemBuilder(Material.WHITE_STAINED_GLASS_PANE).setName(" ").toItemStack());
        }
        ...
        inv.setItem(11, new ItemBuilder(Material.DIAMOND).setName("§a+1").setAmount(1).toItemStack());
        inv.setItem(13, new ItemBuilder(Material.DIAMOND).setName("§a+16").setAmount(16).toItemStack());
        inv.setItem(15, new ItemBuilder(Material.DIAMOND).setName("§a+32").setAmount(32).toItemStack());
        inv.setItem(22, getReturnArrow());
        player.openInventory(inv);
    }
    public void openEmeraldBuyInventory(Player player) {
        Inventory inv = Bukkit.createInventory(player, 9*3, "§c§n§lÉmeraude§7 -§6 "+LotoxShop.getInstance().getStringCoins(player.getUniqueId())+" coins");
        for (int i = 0; i <= 9; i+=7){
            inv.setItem(i, new ItemBuilder(Material.WHITE_STAINED_GLASS_PANE).setName(" ").toItemStack());
            inv.setItem(i+1, new ItemBuilder(Material.WHITE_STAINED_GLASS_PANE).setName(" ").toItemStack());
        }
        ...
        inv.setItem(11, new ItemBuilder(Material.EMERALD).setName("§a+1").setAmount(1).toItemStack());
        inv.setItem(13, new ItemBuilder(Material.EMERALD).setName("§a+16").setAmount(16).toItemStack());
        inv.setItem(15, new ItemBuilder(Material.EMERALD).setName("§a+32").setAmount(32).toItemStack());
        inv.setItem(22, getReturnArrow());
        player.openInventory(inv);
    }
}